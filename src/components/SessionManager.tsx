      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl shadow-md border border-white/40" id="create-session-form-container">
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-purple-950 hover:bg-purple-900 text-white font-bold text-xs py-3 px-4 rounded-xl transition-all shadow-md shadow-purple-950/10 flex items-center justify-center gap-2 mt-4 cursor-pointer uppercase tracking-widest"
        ...
        <div className="glass-panel p-6 rounded-3xl shadow-md border border-white/40" id="join-session-form-container">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h3 className="text-base font-black text-purple-950 tracking-tight">Gabung Sesi Survey Cloud</h3>
          ...
          <form onSubmit={handleJoin} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs py-3 px-4 rounded-xl transition-all shadow-md shadow-purple-600/10 flex items-center justify-center gap-2 mt-4 cursor-pointer uppercase tracking-widest"

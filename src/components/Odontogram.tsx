...
export const DECIDUOUS_CODES = [
  ...
  { code: 'K', label: 'K - Gigi Sudah Tanggal' }
];
...
const ToothCard = ({ num, isDeciduous, teethStatus, onChange, readOnly = false }: ToothCardProps) => {
  ...
  if (val === '1' || val === 'B') {
    ...
    cardBg = 'bg-cyan-100 border-2 border-dashed border-cyan-500';
    textAndBorder = 'text-cyan-950 border-cyan-500';
  }
  ...
  return (
    <div className="w-full bg-white/45 backdrop-blur-md rounded-3xl p-5 border border-white/50 shadow-md space-y-6" id="odontogram-visual-card">
      <div className="flex items-center justify-between border-b border-white/30 pb-3">
        <h4 className="text-xs font-black text-purple-950 uppercase tracking-widest flex items-center gap-2">
          ⚙️ Visualisasi Odontogram (FDI Two-Digit)
        </h4>
        <span className="text-[10px] bg-purple-100/50 text-purple-800 px-2.5 py-1 rounded-full font-black border border-purple-200/20 uppercase tracking-wide">
      ...
      <div className="overflow-x-auto pb-2 scrollbar-thin">
        <div className="min-w-[760px] space-y-3 p-1">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center text-xs font-black text-purple-950/70 uppercase tracking-wider px-2">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center text-xs font-black text-purple-950/70 uppercase tracking-wider px-2 pt-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white/40 p-4 rounded-2xl border border-white/50 text-xs shadow-inner">
        <div className="space-y-1.5">
          <span className="font-extrabold text-purple-950 block border-b border-purple-950/10 pb-1 uppercase text-[10px] tracking-widest">
          ...
          <div className="grid grid-cols-2 gap-x-3 gap-y-1 text-[11px] text-slate-600 font-medium">
            {PERMANENT_CODES.map(c => (
              <div key={c.code} className="flex gap-1 items-center">
                <span className="w-4 font-black font-mono text-purple-900">{c.code}</span>
